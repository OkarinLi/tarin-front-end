...
export const register = (user:any)=> post({
...
export const login = (user:any)=> post({
...
export const getUserInfo = (user_name:string)=>get({url:config.LOCAL_API+'/user?user_id='+user_name})
